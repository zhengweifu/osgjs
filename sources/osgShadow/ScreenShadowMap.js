define( [
    ...
    ShadowMap.prototype = MACROUTILS.objectLibraryClass( MACROUTILS.objectInherit( ShadowTechnique.prototype, {
        ...
        getShadowAtttribute: function () {
            return this._shadowAttribute;
        },
        getTextureAttribute: function () {
            return this._texture;
        },
        ...
        setReceiverStateSet: function ( st ) {
        ...
        aimShadowCastingCamera: function ( cullVisitor, frustumBound ) {
            ...
            var lightMatrix = lightSource.getWorldMatrices()[ 0 ];
